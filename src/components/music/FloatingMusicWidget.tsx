  ...
  return (
    ...
    >
      <div className="relative h-full w-full">
        ...
        {/* Turntable — same protruding silhouette as the homepage card. */}
        <div className="pointer-events-none absolute left-0 top-1/2 aspect-square h-[130%] -translate-y-1/2">
          <div
            aria-hidden="true"
            className={cn(
  ...
  return (
    <button
      ...
      className={cn(
        ...
        primary
          ? "h-8 w-8 bg-accent text-surface-2 text-[14px] hover:brightness-110"
          : "h-6 w-6 text-muted text-[12px] hover:bg-ink/10",
      )}
      {...rest}
    >
      {children}
