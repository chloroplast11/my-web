...
export function AboutCard({ enterIndex }: { enterIndex: number }) {
  return (
    <CardFrame
      ...
      className="relative overflow-hidden rounded-lg border border-line-2 bg-surface shadow-[0_4px_10px_rgba(36,30,23,0.12)] max-md:!static max-md:!left-auto max-md:!top-auto max-md:!w-full max-md:!h-auto max-md:order-1"
    >
      <Link
        href="/about"
        aria-label="about me"
