...
export function PhotosCard({ photo, enterIndex }: { photo: PhotoPreview; enterIndex: number }) {
  return (
    <CardFrame
      ...
      className="overflow-hidden rounded-lg border border-line-2 bg-paper p-3 shadow-[0_4px_10px_rgba(36,30,23,0.12)] max-md:!static max-md:!left-auto max-md:!top-auto max-md:!w-full max-md:!h-auto max-md:col-span-2"
    >
      <Link
        href="/photos"
        aria-label="photos"
