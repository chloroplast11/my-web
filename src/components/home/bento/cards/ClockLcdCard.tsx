...
export function ClockLcdCard({ enterIndex }: { enterIndex: number }) {
  ...
  return (
    <CardFrame
      ...
      className="rounded-lg max-md:hidden max-md:!static max-md:!left-auto max-md:!top-auto max-md:!w-full max-md:!h-auto"
    >
      <div
      ...
      >
        <div
          className="flex h-full w-full items-center justify-center rounded font-mono"
          style={{
